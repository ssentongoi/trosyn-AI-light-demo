...
class SQLiteSyncStorage:
    ...
    def _ensure_db_exists(self) -> None:
        ...
        with self._get_connection() as conn:
            ...
            # Create indexes
            conn.execute('CREATE INDEX IF NOT EXISTS idx_sync_items_item_type ON sync_items(item_type)')
            conn.execute('CREATE INDEX IF NOT EXISTS idx_sync_items_synced ON sync_items(synced)')
            conn.execute('CREATE INDEX IF NOT EXISTS idx_sync_items_created_at ON sync_items(created_at)')
