          ...
          <TableRow>
            ...
            <TableCell>
              <TableSortLabel
                ...
                direction={sort?.field === 'modified' ? sort.direction : 'desc'}
            ...
            documents.map((doc) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell>
                    <Typography variant="body2" color="textSecondary">
                      {doc.modified ? format(new Date(doc.modified), 'PPpp') : 'N/A'}
                    </Typography>
                  </TableCell>
                  <TableCell>
                    <Typography variant="body2" color="textSecondary">
                  ...
                  <TableCell>
                    <Box display="flex" alignItems="center">
                      {showStarToggle && (
                        <Tooltip title={doc.starred ? mergedI18n.unstarDocument : mergedI18n.starDocument}>
                          <IconButton
                            size="small"
                            onClick={(e) => {
                              e.stopPropagation();
                              handleStarToggle(doc.id, !doc.starred);
                            }}
                          >
