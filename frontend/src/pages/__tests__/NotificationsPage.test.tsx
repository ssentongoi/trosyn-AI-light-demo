...
// Define a test-specific notification type that matches the service
type TestNotification = Omit<Notification, 'timestamp'> & {
...
// Extend the mock to include our test properties
declare module '../../services/notificationService' {
  interface NotificationService {
    mockCallback: (notifications: Notification[]) => void;
...
const createTestNotification = (overrides: Partial<TestNotification> = {}): Notification => {
...
describe('NotificationsPage', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(notificationService.subscribe).mockImplementation((callback) => {
      ...
      (notificationService as any).mockCallback = callback;
  ...
  it('updates when notifications change', async () => {
    ...
    (notificationService as any).mockCallback([...mockNotifications, newNotification]);
