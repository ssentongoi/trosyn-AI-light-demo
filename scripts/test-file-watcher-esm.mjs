// Simple test script for FileWatcherService (ESM version)
...
// Import the built files using dynamic import
const { DatabaseService } = await import('../dist/main/DatabaseService.js');
const { FileWatcherService } = await import('../dist/main/services/FileWatcherService.js');
