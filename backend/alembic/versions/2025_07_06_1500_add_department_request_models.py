...
def upgrade():
    ...
    request_priority = postgresql.ENUM(
        "low", "medium", "high", "critical", name="requestpriority", create_type=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "priority", request_priority, nullable=False, server_default="medium"
        ),
    ...
    op.create_index(
        op.f("ix_department_requests_id"), "department_requests", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["request_id"], ["department_requests.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_request_comments_id"), "request_comments", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_request_attachments_id"), "request_attachments", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_request_history_request_id"),
        "request_history",
        ["request_id"],
        unique=False,
    )
