...
from ....services.role import PermissionService, RoleService
...
async def assign_role_to_user(
    ...
    return await RoleService.assign_role_to_user(
        db=db, user_id=assignment.user_id, role_id=assignment.role_id
    )
...
async def create_permission(
    ...
    db_permission = await PermissionService.get_permission_by_name(
...
async def assign_permission_to_role(
    ...
    return await PermissionService.assign_permission_to_role(
        db=db, role_id=assignment.role_id, permission_id=assignment.permission_id
    )
