...
from ..models.department_request import (
    DepartmentRequest,
    RequestPriority,
    RequestStatus,
    RequestType,
...
class DepartmentRequestService:
    ...
    async def create_request(
        self, request_in: DepartmentRequestCreate, requester_id: int
    ) -> DepartmentRequest:
    ...
    async def update_request(
        self, request_id: int, request_in: DepartmentRequestUpdate, user_id: int
    ):
...
async def get_department_request_service(
...
@router.post(
    "/", response_model=DepartmentRequestResponse, status_code=status.HTTP_201_CREATED
)
