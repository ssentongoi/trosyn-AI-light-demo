        ...
        "documents": [
            {
                ...
                "version_id": (
                    str(doc.current_version.id) if doc.current_version else None
                ),
                "version_hash": (
                    doc.current_version.version_hash if doc.current_version else None
                ),
                "title": doc.title,
...
async def sync_document(
    ...
    try:
        ...
        return {
            ...
            "version_id": (
                str(doc.current_version_id) if doc.current_version_id else None
            ),
        }
